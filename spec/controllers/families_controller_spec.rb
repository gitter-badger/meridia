  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved family as @family" do
        ...
        post :create, {:family => { "firstname" => "invalid value" }}, valid_session
        assigns(:family).should be_a_new(Family)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested family" do
        ...
        Family.any_instance.should_receive(:update).with({ "firstname" => "MyString" })
        put :update, {:id => family.to_param, :family => { "firstname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the family as @family" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Family.any_instance.stub(:save).and_return(false)
        put :update, {:id => family.to_param, :family => { "firstname" => "invalid value" }}, valid_session
        assigns(:family).should eq(family)
      end
