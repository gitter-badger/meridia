namespace :test do
  ...
  task :setup_test=> :environment do
    ...
    def personal_history 
      ...
      #test_build(test,"Lugar y fecha de nacimiento. Edad:" ,"multitext" )
      #test_build(test,"¿Qué recuerda de su infancia y a qué le gustaba jugar?" ,"text" )
      #test_build(test,"Lugares donde ha vivido: " ,"text" )
      #test_build(test,"¿Qué estudió? " ,"text" )
      #test_build(test,"Ocupación actual: Ocupación anterior" ,"text" )
